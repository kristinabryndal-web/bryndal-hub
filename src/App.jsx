...
export default function App() {
  ...
  const pageMap = { home: Home, sat: SAT, act: ACT, tests: TestMode, drills: MathDrills, studyguide: StudyGuide, colleges: Colleges, essays: Essays }
